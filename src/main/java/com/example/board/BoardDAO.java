...
public class BoardDAO
{
    ...
    private final String ITEMS_LIST = "select * form ITEMS order by seq desc";
    ...
    public BoardVO getItems(int seq){
        return template.queryForObject(ITEMS_GET, new Object[]{seq}, new BeanPropertyRowMapper<BoardVO>(BoardVO.class));
    }

    public List<BoardVO> getItemsList(){
        return template.query(ITEMS_LIST, new RowMapper<BoardVO>(){
            @Override
